...
public class OwnTargetEffect : Effect , ITileCilckTrigger ,INodeTileDetect
{
   ...
   public float GetEffectRenge()
    ...
    public override bool CardSelection()
    {
       ...
       var objects = GameSceneManager.Instance.oponentPlayer.GetObjects<AimObject>();
    ...
    public Node NodeDetect( OponentPlayer player)
    {
        ...
        aimObjects.AddRange(gsm.oponentPlayer.GetObjects<AimObject>());
